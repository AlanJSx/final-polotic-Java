...
<body class="container">   
    ...
    <main>
        <div class="mx-auto">
            <form action="SvReservationConfirm" method="Post" class="g-3">
                <div class="row mb-3">
                    <div class="col">
                    ...
                    <div class="col">
                        ...
                        <input type="text" name="birthDate" class="form-control" value="<%= mySession.getAttribute("guestBirth") %>" disabled>
                    </div>
                </div>
                <div class="row mb-3">
                    <div class="col">
                        <label for="name" class="form-label">Nombre</label>
                        <input type="text" name="name" class="form-control" value="<%= mySession.getAttribute("guestName") %>" disabled>
                    </div>
                    <div class="col">
                        <label for="lastName" class="form-label">Apellido</label>
                        <input type="text" name="lastName" class="form-control" value="<%= mySession.getAttribute("guestLastname") %>" disabled>
                    </div>
                </div>
                ...
                <div class="row mb-3">
                    <div class="col">
                        ...
                        <input type="text" name="adress" class="form-control" value="<%= mySession.getAttribute("guestAdress") %>" disabled>
                    </div>
                    <div class="col">
                        <label for="career" class="form-label">Profesión</label>
                        <input type="text" name="career" class="form-control" value="<%= mySession.getAttribute("guestCareer") %>" disabled>
                    </div>
                </div>
                ...
                <div class="row mb-3">
                    ...
                    <div class="col">
                        <label for="selectedRoom" class="form-label">Habitación Seleccionada</label>
                        <input type="text" name="numberPeople" class="form-control" value="<%= mySession.getAttribute("selectedRoomName") %>" disabled>
                    </div>
                </div>
